...
with gr.Blocks(theme=THEME) as app:
    ...
    <div class="info-box">
        ...
        <p>It combines:</p>
        <ul>
            <li><a href="https://github.com/openai/whisper" target="_blank">Whisper-Turbo</a> for transcription.</li>
...
if __name__ == "__main__":
    ...
    app.launch(
        server_name="127.0.0.1", server_port=7861, root_path="/long_v3", show_api=True
    )
